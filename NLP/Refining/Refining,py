...
bugs_data1 = pd.read_csv('./bugs_comments_벚꽃엔딩.csv',index_col=0)
bugs_data2 = pd.read_csv('./bugs_comments_나만, 봄.csv',index_col=0)
bugs_data3 = pd.read_csv('./bugs_comments_꽃송이가.csv',index_col=0)

genie_data1 = pd.read_csv('./genie_comments_벚꽃엔딩.csv',index_col=0)
genie_data2 = pd.read_csv('./genie_comments_나만, 봄.csv',index_col=0)
genie_data3 = pd.read_csv('./genie_comments_꽃송이가.csv',index_col=0)
...
genie_bugs_processing(bugs_data1)
genie_bugs_processing(bugs_data2)
genie_bugs_processing(bugs_data3)
genie_bugs_processing(genie_data1)
genie_bugs_processing(genie_data2)
genie_bugs_processing(genie_data3)
...
bugs_data1.to_csv('bugs_refined_벚꽃엔딩.csv', mode='w',encoding='utf-8')
bugs_data2.to_csv('bugs_refined_나만,봄.csv', mode='w',encoding='utf-8')
bugs_data3.to_csv('bugs_refined_꽃송이가.csv', mode='w',encoding='utf-8')

genie_data1.to_csv('genie_refined_벚꽃엔딩.csv', mode='w',encoding='utf-8')
genie_data2.to_csv('genie_refined_나만,봄.csv', mode='w',encoding='utf-8')
genie_data3.to_csv('genie_refined_꽃송이가.csv', mode='w',encoding='utf-8')
